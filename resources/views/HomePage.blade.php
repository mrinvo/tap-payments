...
<html>
    ...
    <body>
        ...
        <section id="checkoutTypeAsAGuest" class="hidden">
            <div class="container">
                <div class="horizontalDiv">
                    <form class="sendEmailForm">
                        ...
                        <p>You Will Pay <span class="paidAmount" id="paidAmountSpan"></span></p>
                        <div>
                            <input type ="button" value="Make a Payment" class="sendEmailButton" onclick="getCheckoutFormPay()">
                        </div>
                    </form>
                </div>
            </div>
